...
![Manitux Logo](https://github.com/xbmc/xbmc/raw/master/docs/resources/banner_slim.png)
...
* Own header file
* Other Manitux includes (platform independent)
* Other Manitux includes (platform specific)
* C and C++ system files
* Other libraries' header files
* special Manitux headers (PlatformDefs.h, system.h and system_gl.h)

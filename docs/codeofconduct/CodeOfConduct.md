...
-   Our primary aim is to make Manitux the best open source media player
...
1. Discrimination, harassment, threatening/bullying behaviour, trolling
    ...
    via any Manitux channel or site.
...
1. Publication and sharing of confidential information, both relating
    to Manitux and to individual's personal data, is only by explicit permission
    of the relevant information owner and person(s) concerned, as applicable.

1. Work on Manitux is a team effort.
...
1. If you are a team member, you may have the title of "Team Manitux Member"
   (or variants thereof) in environments like the Manitux forum. You are of
...
-   This code covers all services supplied by and used by Team Manitux,
    such as:
    ...
    -   The Manitux Slack and IRC channels.

    -   Official Manitux social media channels.

    -   Devcon.

-   Anyone who contributes to the Manitux project on any of these channels
    is expected to abide by this code.

## **Enforcement:**

-   Violations of this code which cannot be dealt with by simple
    discussion should be reported to the working group via conduct@manitux.tv .
...
-   The procedure upon receiving a report should be:
    ...
    1.  This action will depend on the severity of the transgression and
        ...
        -   Final offence -- banning from all Manitux services.
        ...
        For individuals that are not members of Team Manitux, there are no
...
-   *Manitux Foundation Board* -- the elected five directors and management
...
-   *Contributors* -- volunteers who give input into the upkeep and
    improvement of Manitux and its community, be they Team Members or
...
-   [Forum rules](https://manitux.wiki/view/Official:Forum_rules)

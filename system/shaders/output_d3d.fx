...
#endif
#if (defined(MANITUX_TONE_MAPPING_ACES) || defined(MANITUX_TONE_MAPPING_HABLE) || defined(MANITUX_HLG_TO_PQ))
...
#endif
#if defined(MANITUX_TONE_MAPPING_REINHARD)
float g_toneP1;
float3 g_coefsDst;
...
#endif
#if defined(MANITUX_TONE_MAPPING_ACES)
float g_luminance;
float g_toneP1;
...
#endif
#if defined(MANITUX_TONE_MAPPING_HABLE)
float g_toneP1;
float g_toneP2;
...
#endif
#if (defined(MANITUX_TONE_MAPPING_ACES) || defined(MANITUX_TONE_MAPPING_HABLE))
